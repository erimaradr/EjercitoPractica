...
{
    [MetadataType(typeof(Tanque))]

    public partial class Tanque { }
    public partial class TanqueMetadata
    {
        [Required(ErrorMessage = "El código del tanque debe tener tres carácteres")]
        [Display(Name = "Cod. Tanque")]
